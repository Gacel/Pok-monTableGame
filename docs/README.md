...
| 33 | [`33-TRADING.md`](33-TRADING.md) | Intercambio (Épica 10): backend con escrow — Pokémon+objetos+monedas entre amigos (T10.1); UI y evoluciones por intercambio, pendientes. |
