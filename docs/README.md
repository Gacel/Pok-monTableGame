...
- El número refleja el **orden de creación**, no la importancia ni un orden de
  ...
  (el último a día de hoy es `21`, así que el próximo sería `22-*.md`).
...
| 21 | [`21-STEALTH_REVEAL.md`](21-STEALTH_REVEAL.md) | Revelación de un oculto al ser golpeado por un AoE (flag `revealed`, evento `reveal`, emboscada intacta). (Ticket T1.1) |
